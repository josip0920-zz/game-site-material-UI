                        ...
                        <div className="row align-items-center">
                            <div className="col-12">
                                <div className="hero_content">
                                    ...
                                    <a className="btn btn-link wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s" href="#">Play Now <img src={require("../assets/img/theme/icon/arrrow-icon.webp").default} alt="" /> </a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="upcoming_gaming_section mb-125">
                <div className="container">
                    ...
                    <div className="upcoming_gaming_inner">
                        <div className="upcoming_gaming_list wow fadeInUp d-flex justify-content-between align-items-center mb-30" data-wow-delay="0.1s" data-wow-duration="1.1s">
                            <div className="upcoming_gaming_text">
                                ...
                                <h3><a href="#">Roar Spring Game 2021</a></h3>
                                <span>08 Teams Registered</span>
                            </div>
                            <div className="upcoming_play_video text-center">
                                <a className="video_popup" href="#"><img src={require("../assets/img/theme/others/play-btn2.webp").default} alt="" /></a> <br />
                        ...
                        <div className="upcoming_gaming_list wow fadeInUp d-flex justify-content-between align-items-center mb-30" data-wow-delay="0.2s" data-wow-duration="1.2s">
                            <div className="upcoming_gaming_text">
                                <p>20 August 2021  -  09:00 PM</p>
                                <h3><a href="#">Skrit tournament 2021</a></h3>
                                <span>08 Teams Registered</span>
                            </div>
                            <div className="upcoming_play_video text-center">
                                <a className="video_popup" href="#"><img src={require("../assets/img/theme/others/play-btn2.webp").default} alt="" /></a> <br />
                        ...
                        <div className="upcoming_gaming_list wow fadeInUp d-flex justify-content-between align-items-center" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            <div className="upcoming_gaming_text">
                                <p>20 August 2021  -  09:00 PM</p>
                                <h3><a href="#">Ninja 360 Game 2021</a></h3>
                                <span>08 Teams Registered</span>
                            </div>
                            <div className="upcoming_play_video text-center">
                                <a className="video_popup" href="#"><img src={require("../assets/img/theme/others/play-btn2.webp").default} alt="" /></a> <br />
                    ...
                    <div className="others_match_btn text-center">
                        <a className="btn btn-link" href="#">Other’s Match </a>
                    </div>
                </div>
            </section>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="popular_gaming_thumb">
                                    ...
                                    <div className="gaming_details_btn">
                                        <a className="btn btn-link" href="#">Game Details <img src={require("../assets/img/theme/icon/arrrow-icon.webp").default} alt="" /> </a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6">
                ...
                <div className="container">
                    ...
                    <div className="row blog_inner">
                        <div className="col-lg-6">
                            <div className="single_blog d-flex align-items-center wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                                <div className="blog_thumb">
                                    <a href="#"><img src={require("../assets/img/theme/blog/blog1.webp").default} alt="" /></a>
                                </div>
                                <div className="blog_content">
                                    <div className="blog_date">
                                        <span><i className="icofont-calendar"></i>  20 January 2021</span>
                                    </div>
                                    <h3><a href="#">if you have seen Apple&apos;s
                                        recent jabs.</a></h3>
                                    <a href="#">READ MORE</a>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6">
                            <div className="single_blog d-flex align-items-center wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                                <div className="blog_thumb">
                                    <a href="#"><img src={require("../assets/img/theme/blog/blog2.webp").default} alt="" /></a>
                                </div>
                                <div className="blog_content">
                                    <div className="blog_date">
                                        <span><i className="icofont-calendar"></i>  20 January 2021</span>
                                    </div>
                                    <h3><a href="#">Lorem ipsum dolor sit amet, adipisicing elit.</a></h3>
                                    <a href="#">READ MORE</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="single_blog d-flex align-items-center wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                                <div className="blog_thumb">
                                    <a href="#"><img src={require("../assets/img/theme/blog/blog3.webp").default} alt="" /></a>
                                </div>
                                <div className="blog_content">
                                    <div className="blog_date">
                                        <span><i className="icofont-calendar"></i>  20 January 2021</span>
                        ...
                        <div className="col-lg-6">
                            <div className="single_blog d-flex align-items-center wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                                <div className="blog_thumb">
                                    <a href="#"><img src={require("../assets/img/theme/blog/blog4.webp").default} alt="" /></a>
                                </div>
                                <div className="blog_content">
                                    <div className="blog_date">
                                        <span><i className="icofont-calendar"></i>  20 January 2021</span>
